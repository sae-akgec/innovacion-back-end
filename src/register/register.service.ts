...
export class RegisterService {
    ...
    sendMail(leader: Student, teamName: string) {        
        ...
        transporter.sendMail({
            ...
            html: `<p>Your team ${teamName} has been successfully registered for SAE-2019</p>
                   <p>Please complete the payment process by paying the registration fees via PayTM</p>`
        });
    }
}